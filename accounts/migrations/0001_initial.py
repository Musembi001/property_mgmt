    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('landlord', 'Landlord'), ('tenant', 'Tenant'), ('agent', 'Agent'), ('caretaker', 'Caretaker')], max_length=20)),
                ...
                ('assigned_property', models.CharField(blank=True, max_length=100, null=True)),
