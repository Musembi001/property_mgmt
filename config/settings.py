...
SECRET_KEY = 'django-insecure-t)@)c#bmc2(y$h7h+ff@i)-j%-+0__xu2i(0a-s$gs$a#s0-$u'
...
INSTALLED_APPS = [
    ...
    # 'allauth.socialaccount.providers.apple',  # Apple requires extra setup
    "smart_selects",
    "django_select2",
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Now points to property_mgmt/templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
